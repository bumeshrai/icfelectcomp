...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'coachType',  
				CHtml::listData(Coach::model()->findAll(array('order'=>'type ASC')), 'coachId', 'type')); ?>
	...
	<div class="row">
		...
		<?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
         ...
         'maxDate'=>'+0',
         //'minDate'=>'-2y',
         //'minDate'=>'#Casesheet_dateCommission',
 			'showButtonPanel' => false, 
         'changeMonth' => true,
 			'changeYear' => true,
 			'constrainInput' => false,
			...
			'beforeShow' => 'js:function(){
         	var selectedDate=$("#'.CHtml::activeId($model,'dateCommission').'").datepicker("getDate");
	...
	<div class="row">
		<?php echo $form->labelEx($model,'imageData'); ?>
		<?php echo $form->fileField($model,'imageData'); ?>
		<?php echo $form->error($model,'imageData'); ?>
	</div>
